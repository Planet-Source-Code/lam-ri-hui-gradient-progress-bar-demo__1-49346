...
Begin VB.UserControl PB_Grey 
   ...
   End
End
Attribute VB_Name = "PB_Grey"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'Grey Gradient Progress Bar - A Progress Bar with grey gradient
'Code(C)Lam Ri Hui (rihui@email.com)
'Version year 2003
'This is a progress bar with grey gradient.
