VERSION 5.00
Begin VB.UserControl PB_Yellow 
   AutoRedraw      =   -1  'True
   ClientHeight    =   390
   ClientLeft      =   0
   ClientTop       =   0
   ...
   End
End
Attribute VB_Name = "PB_Yellow"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'Yellow Gradient Progress Bar - A Progress Bar with yellow gradient
'Code(C)Lam Ri Hui (rihui@email.com)
'Version year 2003
'This is a progress bar with yellow gradient.
