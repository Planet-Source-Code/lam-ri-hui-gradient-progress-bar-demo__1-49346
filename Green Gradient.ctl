...
Begin VB.UserControl PB_Green 
   ...
   End
End
Attribute VB_Name = "PB_Green"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = True
Attribute VB_PredeclaredId = False
Attribute VB_Exposed = False
'Green Gradient Progress Bar - A Progress Bar with green gradient
'Code(C)Lam Ri Hui (rihui@email.com)
'Version year 2003
'This is a progress bar with green gradient.
